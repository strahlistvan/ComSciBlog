...
<html>
    <head>
        <title>Üdvözöljük, <? print $host; ?>!</title>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://www.hostinger.hu/"><img src="http://www.hostinger.hu/images/logo-hu.png" alt="Tárhely" /></a>
                </div>
                <div class="content">
                    <h1>A fiók elkészült!</h1>
                    <p>A <b><? print $host; ?></b> honlap sikeresen fel lett telepítve a szerverre! Kérjük, törölje le a <b>default.php</b> fájlt a <b>public_html</b> mappából, és töltse fel honlapját FTP vagy Fájlkezelő segítségével.</p>
                    <p>Itt található egy lista a public_html mappában található fájlokkal:</p>
                    <div id="files">
                        <div class="top"></div>
                        <div class="cont">
            ...
            <div id="footer">
                <div class="links">
                    <a href="http://www.hostinger.hu/tarhely" target="_blank">Tárhely</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.hu/ingyenes-tarhely" target="_blank">Ingyenes tárhely</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.hu/forum" target="_blank">Támogatási fórum</a> 
                    <span class="pipe">|</span> 
                    <a href="http://cpanel.hostinger.hu/" target="_blank">Belépés</a>
                </div>
                <div class="copyright">Hostinger Magyarország &copy; <? print date('Y'); ?>. Minden jog fenntartva.</div>
                <div class="social-icons">
                    <a href="http://www.facebook.com/Hostinger.hu"><img src="http://www.main-hosting.com/hostinger/welcome/images/fb.gif" /></a>
